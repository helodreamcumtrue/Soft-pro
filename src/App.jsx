...
import { 
  ...
  ExternalLink, GitPullRequest, User, FileSpreadsheet, File,
  Search, Bell, Check, ChevronRight, Menu, X, FileIcon, Loader2
} from 'lucide-react';
...
const timelineData = [
  { id: 'v0.1', title: 'Initial Prototypes', date: '2022', status: 'completed', description: 'Core wireframes and feature concepts.' },
  { id: 'v0.1.1', title: 'AI Structure Generation', date: 'Late 2022', status: 'completed', description: 'Database and architectural planning.' },
  { id: 'v0.2', title: 'Private Alpha', date: '2023', status: 'completed', description: 'Initial backend deployment and testing.' },
  { id: 'v0.2.2', title: 'Teams and Multiplayer', date: 'Early 2024', status: 'completed', description: 'Real-time collaboration features.' },
  { id: 'v0.3', title: 'Public Beta', date: '2024', status: 'active', description: 'Current working version for professor review.' },
  { id: 'v1.0', title: 'General Availability', date: 'Coming soon', status: 'upcoming', description: 'Final release and documentation.' },
];

const moodboardImages = [
  { id: 1, src: 'https://images.unsplash.com/photo-1522071820081-009f0129c71c?auto=format&fit=crop&q=80&w=800' },
  { id: 2, src: 'https://images.unsplash.com/photo-1552664730-d307ca884978?auto=format&fit=crop&q=80&w=800' },
  { id: 3, src: 'https://images.unsplash.com/photo-1542744173-8e7e53415bb0?auto=format&fit=crop&q=80&w=800' },
  { id: 4, src: 'https://images.unsplash.com/photo-1531482615713-2afd69097998?auto=format&fit=crop&q=80&w=800' },
  { id: 5, src: 'https://images.unsplash.com/photo-1515378791036-0648a3ef77b2?auto=format&fit=crop&q=80&w=800' },
  { id: 6, src: 'https://images.unsplash.com/photo-1553877522-43269d4ea984?auto=format&fit=crop&q=80&w=800' },
];

const teamMembers = [
  { id: 1, name: 'Arshdeep Kaur', handle: '@arshdeep', time: '12m ago', image: 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?auto=format&fit=crop&q=80&w=400', bg: 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?auto=format&fit=crop&q=80&w=800', resumeLink: 'https://www.youtube.com/watch?v=dQw4w9WgXcQ&list=RDdQw4w9WgXcQ&start_radio=1' },
  { id: 2, name: 'Harshita', handle: '@harshita', time: '1h ago', image: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=crop&q=80&w=400', bg: 'https://images.unsplash.com/photo-1605379399642-870262d3d051?auto=format&fit=crop&q=80&w=800', resumeLink: 'https://www.youtube.com/watch?v=dQw4w9WgXcQ&list=RDdQw4w9WgXcQ&start_radio=1' },
  { id: 3, name: 'Lakshay', handle: '@lakshay', time: '2h ago', image: 'https://images.unsplash.com/photo-1531123897727-8f129e1bf08c?auto=format&fit=crop&q=80&w=400', bg: 'https://images.unsplash.com/photo-1561070791-2526d30994b5?auto=format&fit=crop&q=80&w=800', resumeLink: 'https://linktr.ee/lakshay.j' },
  { id: 4, name: 'Parth', handle: '@parth', time: '5h ago', image: 'https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?auto=format&fit=crop&q=80&w=400', bg: 'https://images.unsplash.com/photo-1552664730-d307ca884978?auto=format&fit=crop&q=80&w=800', resumeLink: 'https://www.youtube.com/watch?v=dQw4w9WgXcQ&list=RDdQw4w9WgXcQ&start_radio=1' },
];

const initialTeamTodos = [
  { id: 1, name: 'Arshdeep Kaur', tasks: [{ id: 't1', text: 'ideate on event shield idea', done: true }, { id: 't2', text: 'finalize the ppt content for event shield presentation', done: false }] },
  { id: 2, name: 'Harshita', tasks: [{ id: 't3', text: 'ideate on contruction wala idea', done: true }, { id: 't4', text: 'finalize the ppt content for contruction presentation', done: false }, { id: 't5', text: 'do idea validation with actually users', done: false }] },
  { id: 3, name: 'Lakshay', tasks: [{ id: 't6', text: 'ideate on insurance wala idea', done: true }, { id: 't7', text: 'finalize the ppt content for insurance presentation', done: false }, { id: 't8', text: 'fix frontend for the portal', done: false }] },
  { id: 4, name: 'Parth', tasks: [{ id: 't9', text: 'ideate on project graveyard wala idea', done: true }, { id: 't10', text: 'finalize the ppt content for project graveyard presentation', done: false }, { id: 't11', text: 'do idea validation with srudent whose will use our platform.', done: false }] }
];

const documentsList = [
  { id: 'doc1', name: 'Project_Proposal_Final.pdf', type: 'pdf', date: 'Oct 24, 2024', author: 'Parth', size: '2.4 MB' },
  { id: 'doc2', name: 'Q3_Project_Roadmap.xlsx', type: 'sheet', date: 'Yesterday, 04:15 PM', author: 'Harshita', size: '1.1 MB' },
  { id: 'doc3', name: 'System_Architecture_v2.docx', type: 'doc', date: 'Oct 12, 2024', author: 'Lakshay', size: '845 KB' },
  { id: 'doc4', name: 'User_Testing_Results.pdf', type: 'pdf', date: 'Oct 10, 2024', author: 'Arshdeep Kaur', size: '4.2 MB' },
];

const versionHistoryData = [
  { id: 'v0.3.1', date: 'Oct 24, 2024', author: 'Arshdeep Kaur', title: 'Beta Release Patch', description: 'Fixed navigation bugs, refined moodboard UI, and optimized image loading times.', type: 'patch', status: 'deployed' },
  { id: 'v0.3.0', date: 'Oct 20, 2024', author: 'Lakshay', title: 'Public Beta Release', description: 'Deployed core features including Dashboard, interactive Timeline, and initial Professor Review module.', type: 'minor', status: 'deployed' },
  { id: 'v0.2.0', date: 'Sep 15, 2024', author: 'Harshita', title: 'Private Alpha', description: 'Initial testing phase with core team. Basic routing and static pages established.', type: 'major', status: 'archived' },
];
...
function LandingView({ onEnter }) {
  return (
    <div className="flex flex-col min-h-screen w-full bg-[#fcfcfc] text-gray-900 overflow-y-auto selection:bg-black selection:text-white">
      ...
      <div className="max-w-6xl mx-auto w-full space-y-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          <div className="bg-white border border-gray-200 p-5 rounded-lg shadow-sm">
            ...
            <div className="mt-2 text-[11px] font-medium text-blue-700 bg-blue-50 inline-block px-2 py-0.5 rounded-sm border border-blue-200">Ideation Phase</div>
          </div>
          <div className="bg-white border border-gray-200 p-5 rounded-lg shadow-sm">
            <div className="text-gray-500 text-[11px] font-medium uppercase tracking-wider mb-2">Tasks Done</div>
            <div className="text-xl font-semibold text-gray-900 tracking-tight">4 <span className="text-gray-400 text-base font-normal">/ 10</span></div>
            <div className="mt-2 text-[11px] text-gray-500">6 remaining this sprint</div>
          </div>
          <div className="bg-white border border-gray-200 p-5 rounded-lg shadow-sm">
            <div className="text-gray-500 text-[11px] font-medium uppercase tracking-wider mb-2">Deadline</div>
            <div className="text-xl font-semibold text-gray-900 tracking-tight">Aug 05</div>
            <div className="mt-2 text-[11px] font-medium text-rose-700 bg-rose-50 inline-block px-2 py-0.5 rounded-sm border border-rose-200">Due Today</div>
          </div>
        </div>
                  ...
                  <div className="p-4 space-y-3 flex-1 min-h-[140px]">
                    <AnimatePresence>
                      ...
                      {member.tasks.map(task => (
                        ...
                        >
                          <button onClick={() => toggleTask(member.id, task.id)} className="mt-0.5 text-gray-300 hover:text-black transition-colors focus:outline-none flex-shrink-0">
                          ...
                          <button onClick={() => deleteTask(member.id, task.id)} className="opacity-0 group-hover:opacity-100 text-gray-400 hover:text-red-600 transition-opacity focus:outline-none flex-shrink-0">
                            <Trash2 size={13} />
                          </button>
                        </motion.div>
                      ))}
          ...
          {moodboardImages.map((img, idx) => (
            ...
            >
              <div className={`overflow-hidden bg-[#111] border border-white/10 ${idx % 3 === 0 ? 'h-[75%]' : 'h-[90%]'} rounded-md shadow-lg`}>
                <img src={img.src} alt="Moodboard Capture" className="w-full h-full object-cover opacity-80 group-hover:opacity-100 transition-transform duration-700 group-hover:scale-105" />
              </div>
            </motion.div>
          ))}
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {teamMembers.map((member, idx) => (
            <motion.div 
              ...
              className="bg-white rounded-[20px] border border-gray-200 shadow-sm overflow-hidden flex flex-col group hover:border-gray-300 transition-all"
            >
              ...
              <div className="relative h-64 bg-gray-100 overflow-hidden">
                ...
                <div className="absolute top-6 left-0 right-0 flex flex-col items-center z-10 px-4">
                  <h3 className="text-white text-xl font-medium tracking-tight mb-1">{member.name}</h3>
              ...
              <div className="p-3 flex items-center justify-between bg-white z-20">
                <div className="flex items-center gap-2">
                  ...
                  <div className="flex flex-col">
                    <span className="text-[12px] font-semibold text-gray-900 leading-none">{member.handle}</span>
                    <span className="text-[10px] text-gray-500 mt-0.5 font-medium">{member.time}</span>
                  </div>
                </div>
                
                <a href={member.resumeLink} target="_blank" rel="noopener noreferrer" className="bg-[#1c1c1e] text-white px-3.5 py-1.5 rounded-lg text-[11px] font-medium hover:bg-black transition-colors shadow-sm whitespace-nowrap flex items-center gap-1">
                  <Plus size={12} className="text-white/70" /> View Resume
                </a>
              </div>
            </motion.div>
          ))}
            ...
            {documentsList.map((doc) => (
              <div key={doc.id} className="grid grid-cols-12 gap-4 p-4 items-center hover:bg-gray-50/50 transition-colors group cursor-pointer">
                <div className="col-span-8 md:col-span-5 flex items-center gap-3">
                  <div className={`p-2 rounded-md border border-gray-200 bg-white shadow-sm flex-shrink-0 ${doc.type === 'pdf' ? 'text-red-600' : doc.type === 'sheet' ? 'text-emerald-600' : 'text-blue-600'}`}>
            ...
            <div className="bg-white border border-gray-200 rounded-lg shadow-sm overflow-hidden">
              <div className="p-5 border-b border-gray-200 bg-gray-50/80 flex justify-between items-center">
                <div>
                  ...
                  <p className="text-[15px] font-medium text-gray-900 mt-0.5 tracking-tight">Public Beta Build</p>
                </div>
                ...
                <div>
                  ...
                  <div className="bg-gray-50 p-4 rounded-md border border-gray-200">
                    <p className="text-[13px] text-gray-600 leading-relaxed font-serif italic">
                      "Professor, we have implemented the core UI and routing as requested. The backend integration is mocked for now, pending database approval."
                    </p>
                  </div>
                </div>
              </div>
